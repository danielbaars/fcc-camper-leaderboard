...
/***/ (function(module, exports, __webpack_require__) {
	...
	var URL_RECENT = 'https://fcctop100.herokuapp.com/api/fccusers/top/recent';
	var URL_ALLTIME = 'https://fcctop100.herokuapp.com/api/fccusers/top/alltime';
	...
	var Table = function (_Component) {
	  ...
	  function Table(props) {
	    ...
	    _this2.showList(_this2.state.list);
	    _this2.showList = _this2.showList.bind(_this2);
	    return _this2;
	  }
	  ...
	  _createClass(Table, [{
	    ...
	    value: function tableRow() {
	      ...
	      return array.map(function (camper, index) {
	        return _react2.default.createElement(
	          'tr',
	          { key: index },
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'td',
	            null,
	            _react2.default.createElement('img', { src: camper.img, className: 'avatar' }),
	            ' ',
	            _react2.default.createElement(
	              'strong',
	              null,
	    ...
	    value: function showList(list) {
	      var _this = this;
	      _axios2.default.get(list === RECENT ? URL_RECENT : URL_ALLTIME).then(function (response) {
	        _this.setState({
	          list: list,
	          data: response.data
	        });
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { onClick: function onClick() {
	                  return _this3.showList(RECENT);
	                }, style: clickable, className: "recent " + (this.state.list === RECENT ? 'active' : '') },
	              'Points in past 30 days'
	            ),
	            _react2.default.createElement(
	              'th',
	              { onClick: function onClick() {
	                  return _this3.showList(ALLTIME);
	                }, style: clickable, className: "alltime " + (this.state.list === ALLTIME ? 'active' : '') },
	              'All time points'
	            )
	          )
	        ),
